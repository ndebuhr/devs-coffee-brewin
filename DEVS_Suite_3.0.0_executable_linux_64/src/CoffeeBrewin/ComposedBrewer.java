...
public class ComposedBrewer extends ViewableDigraph
{
    ...
    {
        preferredSize = new Dimension(773, 329);
        ((ViewableComponent)withName("Boiler")).setPreferredLocation(new Point(25, 34));
        ((ViewableComponent)withName("Transducer")).setPreferredLocation(new Point(322, 250));
        ((ViewableComponent)withName("Requester")).setPreferredLocation(new Point(33, 253));
        ((ViewableComponent)withName("BrewerControl")).setPreferredLocation(new Point(151, 135));
        ((ViewableComponent)withName("CoffeePot")).setPreferredLocation(new Point(308, 38));
    }
}
